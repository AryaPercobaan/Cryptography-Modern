        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
                    ...
                    <li class="nav-item"><a href="<?= base_url(); ?>Home/subs" class="btn btn-danger btn-rounded waves-effect waves-light mb-4">Berlangganan</a>
                    <li class="nav-item"><a class="nav-link" href="<?= base_url(); ?>Home/login">Login</a></li>
    ...
    <header class="masthead">
        <div class="container">
           ...
           <br>
            ...
            <a class="btn btn-outline-primary btn-xl text-uppercase" href="#kriptografi">Ayo Belajar!</a>
        </div>
    </header>
    ...
    <section class="page-section bg-light" id="kriptografi">
        <div class="container">
            <div class="text-center">
                <h2 class="section-heading text-uppercase">Algoritma Kriptografi Modern</h2>
                <h3 class="section-subheading text-muted">Mari kenali dulu yuk kedua algoritma Ini!</h3>
            </div>
            <div class="row">
                <div class="col-lg-4 col-sm-6 mb-4">
                    ...
                    <div class="portfolio-item">
                            ...
                            <center>
                            <img class="img-fluid" src="assets/img/think.png" alt="..." />
                        </a>
                        </center>
                        <br>
                        <center>
                ...
                <div class="col-lg-4 col-sm-6 mb-4">
                    ...
                    <div class="portfolio-item">
                        <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal1">
                            ...
                            <center>
                            <img class="img-fluid" src="assets/img/algoritma/rsa.png" alt="..." />
                        </a>
                        </center>
                        <br>
                        <center>
                        <div class="portfolio-caption">
                            ...
                            <div class="portfolio-caption-subheading text-muted">Algoritma Asimetris</div>
                        </div>
                        </center>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-sm-6 mb-4">
                    ...
                    <div class="portfolio-item">
                        <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal2">
                            ...
                            <center>
                            <img class="img-fluid" src="assets/img/algoritma/aes.png" alt="..." />
                        </a>
                        </center>
                        <br>
                        <center>
                        <div class="portfolio-caption">
                            <div class="portfolio-caption-heading">AES</div>
                            <div class="portfolio-caption-subheading text-muted">Algoritma Simetris</div>
                        </div>
                        </center>
                    </div>
                </div>
...
<!-- Video Grid-->
<section class="page-section bg-info" id="video">
        <div class="container">
            <div class="text-center">
            ...
            <div class="row">
                <div class="col-lg-4 col-sm-6 mb-4">
                    ...
                    <div class="portfolio-item">
                            ...
                            <img class="img-fluid" src="assets/img/vid.png" alt="..." />
                ...
                <div class="col-lg-4 col-sm-6 mb-4">
                    <!-- Portfolio item 1-->
                    <div class="portfolio-item">
                        <a href="https://youtu.be/4q3bA0W7UHg">
                            <div class="portfolio-hover">
                                <div class="portfolio-hover-content"><i class="fas fa-plus fa-3x"></i></div>
                            </div>
                            <img class="img-fluid" src="assets/img/but2.png" alt="..." />
                        </a>
                        <div class="portfolio-caption">
                            <div class="portfolio-caption-heading">Penjelasan Algoritma AES</div>
                            <div class="portfolio-caption-subheading text-muted">By Rinaldi Munir</div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6 mb-4">
                    <!-- Portfolio item 2-->
                    <div class="portfolio-item">
                        <a href="https://youtu.be/2L-BzX1_i4o">
                            <div class="portfolio-hover">
                                <div class="portfolio-hover-content"><i class="fas fa-plus fa-3x"></i></div>
                            </div>
                            <img class="img-fluid" src="assets/img/but3.png" alt="..." />
                        </a>
                        <div class="portfolio-caption">
                            <div class="portfolio-caption-heading">Penjelasan Algoritma RSA</div>
                            <div class="portfolio-caption-subheading text-muted">By Rinaldi Munir</div>
                        </div>
                    </div>
                </div>
    ...
    <section class="page-section bg-light" id="team">
        <div class="container">
            <div class="text-center">
                ...
                <h3 class="section-subheading text-muted">Kriptografi Modern - Keamanan Data</h3>
            </div>
            <div class="row">
                <div class="col-lg-4">
                ...
                <div class="col-lg-4">
                    <div class="team-member">
                        ...
                        <h4>Abu Jazid Bustami</h4>
                        <p class="text-muted">1955301003</p>
    ...
    <footer class="footer py-4">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-4 text-lg-start">Copyright &copy; Kelompok 11 - Kriptografi Modern 2022</div>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-8">
                            <div class="modal-body">
                                <!-- Project details-->
                                <h2 class="text-uppercase">RSA</h2>
                                <p class="item-intro text-muted">Algoritma RSA merupakan salah satu algoritma kunci asimetris. “RSA (dari Rivest-Shamir-Adleman) adalah sebuah kriptografi kunci publik yang berdasarkan pada eksponensial terbatas pada modulo bilangan bulat N(ZN) di mana N adalah sebuah bilangan bulat gabungan dari dua faktor besar (yaitu semi-prime)
</p>
...
pemfaktorannya, semakin kuat pula algoritma RSA. Sistem RSA sekarang digunakan oleh berbagai macam jenis produk, platform, dan industri di seluruh bagian dunia. Algoritma RSA digunakan dalam banyak perangkat lunak yang dijual secara komersial dan direncanakan akan digunakan pada banyak perangkat lunak lainnya. </p>
                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-lg-8">
                            <div class="modal-body">
                                <!-- Project details-->
                                <h2 class="text-uppercase">AES</h2>
                                <p class="item-intro text-muted">Algoritma AES (Advanced Encryption Standard) dipilih karena memiliki tingkat keamanan yang tinggi, dengan tiga pilihan tipe kunci yaitu AES-128, AES-192 dan AES-256. Penelitian ini secara khusus akan mengamati kebutuhan waktu untuk proses enkripsi dan dekripsi, dan ukuran file yang dihasilkan dari proses tersebut.</p>
                                <p>Input dan output dari algoritma AES terdiri dari urutan data sebesar 128 bit. Urutan data
yang sudah terbentuk dalam satu kelompok 128 bit tersebut disebut juga sebagai blok data atau
plaintext yang nantinya akan dienkripsi menjadi ciphertext. Cipher key dari AES terdiri dari key
dengan panjang 128 bit, 192 bit, atau 256 bit. Perbedaan panjang kunci akan mempengaruhi
jumlah round yang akan diimplementasikan pada algoritma AES ini. Berikut ini adalah Tabel 1
yang memperlihatkan jumlah round / putaran ( Nr ) yang harus diimplementasikan pada masingmasing panjang kunc</p>
                                <button class="btn btn-primary btn-xl text-uppercase" data-bs-dismiss="modal" type="button">
                                    <i class="fas fa-xmark me-1"></i>
                                    Tutup
                                </button>
